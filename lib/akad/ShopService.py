...
class getCoinProducts_result(object):
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i1510 in range(_size1506):
                        _elem1511 = CoinProductItem()
                        _elem1511.read(iprot)
                        self.success.append(_elem1511)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for iter1512 in self.success:
                iter1512.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
            oprot.writeFieldBegin('e', TType.STRUCT, 1)
...
class getProductList_args(object):
            ...
            if fid == 2:
                if ftype == TType.LIST:
                    ...
                    for _i1524 in range(_size1520):
                        _elem1525 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.productIdList.append(_elem1525)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.productIdList is not None:
            ...
            for iter1526 in self.productIdList:
                oprot.writeString(iter1526.encode('utf-8') if sys.version_info[0] == 2 else iter1526)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.language is not None:
            oprot.writeFieldBegin('language', TType.STRING, 3)
...
class getProductListWithCarrier_args(object):
            ...
            if fid == 2:
                if ftype == TType.LIST:
                    ...
                    for _i1531 in range(_size1527):
                        ...
                        self.productIdList.append(_elem1532)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.productIdList is not None:
            oprot.writeFieldBegin('productIdList', TType.LIST, 2)
            oprot.writeListBegin(TType.STRING, len(self.productIdList))
            for iter1533 in self.productIdList:
