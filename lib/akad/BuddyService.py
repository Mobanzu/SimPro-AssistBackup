...
class getNewlyReleasedBuddyIds_result(object):
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i1331 in range(_size1327):
                        _key1332 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val1333 = iprot.readI64()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter1334, viter1335 in self.success.items():
                oprot.writeString(kiter1334.encode('utf-8') if sys.version_info[0] == 2 else kiter1334)
                oprot.writeI64(viter1335)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
            oprot.writeFieldBegin('e', TType.STRUCT, 1)
