    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    self.success = []
                    (_etype1453, _size1450) = iprot.readListBegin()
                    for _i1454 in range(_size1450):
                        _elem1455 = ChannelNotificationSetting()
                        _elem1455.read(iprot)
                        self.success.append(_elem1455)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
...
class getFriendChannelMatrices_args(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    self.channelIds = []
                    (_etype1460, _size1457) = iprot.readListBegin()
                    for _i1461 in range(_size1457):
                        _elem1462 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.channelIds.append(_elem1462)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.channelIds is not None:
            ...
            for iter1463 in self.channelIds:
                oprot.writeString(iter1463.encode('utf-8') if sys.version_info[0] == 2 else iter1463)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class issueRequestTokenWithAuthScheme_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i1468 in range(_size1464):
                        _elem1469 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.authScheme.append(_elem1469)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.authScheme is not None:
            ...
            for iter1470 in self.authScheme:
                oprot.writeString(iter1470.encode('utf-8') if sys.version_info[0] == 2 else iter1470)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
class getUpdatedChannelIds_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i1475 in range(_size1471):
                        _elem1476 = ChannelIdWithLastUpdated()
                        _elem1476.read(iprot)
                        self.channelIds.append(_elem1476)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.channelIds is not None:
            ...
            for iter1477 in self.channelIds:
...
class getUpdatedChannelIds_result(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    self.success = []
                    (_etype1481, _size1478) = iprot.readListBegin()
                    for _i1482 in range(_size1478):
                        _elem1483 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.success.append(_elem1483)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for iter1484 in self.success:
                oprot.writeString(iter1484.encode('utf-8') if sys.version_info[0] == 2 else iter1484)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
            oprot.writeFieldBegin('e', TType.STRUCT, 1)
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i1489 in range(_size1485):
                        _elem1490 = ChannelNotificationSetting()
                        _elem1490.read(iprot)
                        self.setting.append(_elem1490)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
