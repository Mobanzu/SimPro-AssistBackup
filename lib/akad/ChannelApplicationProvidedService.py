...
class getCompactContacts_result(object):
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i1361 in range(_size1357):
                        _elem1362 = CompactContact()
                        _elem1362.read(iprot)
                        self.success.append(_elem1362)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for iter1363 in self.success:
                iter1363.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
            oprot.writeFieldBegin('e', TType.STRUCT, 1)
...
class getContactsForChannel_args(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 2:
                if ftype == TType.LIST:
                    self.ids = []
                    (_etype1367, _size1364) = iprot.readListBegin()
                    for _i1368 in range(_size1364):
                        _elem1369 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.ids.append(_elem1369)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.ids is not None:
            ...
            for iter1370 in self.ids:
                oprot.writeString(iter1370.encode('utf-8') if sys.version_info[0] == 2 else iter1370)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i1403 in range(_size1399):
                        ...
                        self.groupIds.append(_elem1404)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class getSimpleChannelContacts_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i1424 in range(_size1420):
                        _elem1425 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.ids.append(_elem1425)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.ids is not None:
            ...
            oprot.writeListBegin(TType.STRING, len(self.ids))
            for iter1426 in self.ids:
                oprot.writeString(iter1426.encode('utf-8') if sys.version_info[0] == 2 else iter1426)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i1431 in range(_size1427):
                        _elem1432 = SimpleChannelContact()
                        _elem1432.read(iprot)
                        self.success.append(_elem1432)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
...
class getUserIdentities_result(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    self.success = {}
                    (_ktype1435, _vtype1436, _size1434) = iprot.readMapBegin()
                    for _i1438 in range(_size1434):
                        _key1439 = iprot.readI32()
                        _val1440 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.success[_key1439] = _val1440
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter1441, viter1442 in self.success.items():
                oprot.writeI32(kiter1441)
                oprot.writeString(viter1442.encode('utf-8') if sys.version_info[0] == 2 else viter1442)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
            oprot.writeFieldBegin('e', TType.STRUCT, 1)
...
class getUserMidsWhoAddedMe_result(object):
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i1447 in range(_size1443):
                        _elem1448 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.success.append(_elem1448)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.LIST, 0)
            oprot.writeListBegin(TType.STRING, len(self.success))
            for iter1449 in self.success:
                oprot.writeString(iter1449.encode('utf-8') if sys.version_info[0] == 2 else iter1449)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
            oprot.writeFieldBegin('e', TType.STRUCT, 1)
