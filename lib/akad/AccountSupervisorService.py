...
class notifyEmailConfirmationResult_args(object):
            ...
            if fid == 2:
                if ftype == TType.MAP:
                    ...
                    for _i1151 in range(_size1147):
                        _key1152 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val1153 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.parameterMap[_key1152] = _val1153
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.parameterMap is not None:
            ...
            for kiter1154, viter1155 in self.parameterMap.items():
                oprot.writeString(kiter1154.encode('utf-8') if sys.version_info[0] == 2 else kiter1154)
                oprot.writeString(viter1155.encode('utf-8') if sys.version_info[0] == 2 else viter1155)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
