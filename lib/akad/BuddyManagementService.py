...
class addBuddyMembers_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i1160 in range(_size1156):
                        ...
                        self.userMids.append(_elem1161)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.userMids is not None:
            ...
            for iter1162 in self.userMids:
                oprot.writeString(iter1162.encode('utf-8') if sys.version_info[0] == 2 else iter1162)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class commitSendMessagesToAll_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i1167 in range(_size1163):
                        ...
                        self.requestIdList.append(_elem1168)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.requestIdList is not None:
            ...
            for iter1169 in self.requestIdList:
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i1174 in range(_size1170):
                        _elem1175 = SendBuddyMessageResult()
...
class commitSendMessagesToMids_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i1181 in range(_size1177):
                        _elem1182 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.requestIdList.append(_elem1182)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.LIST:
                    ...
                    for _i1187 in range(_size1183):
                        _elem1188 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.mids.append(_elem1188)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.requestIdList is not None:
            oprot.writeFieldBegin('requestIdList', TType.LIST, 1)
            oprot.writeListBegin(TType.STRING, len(self.requestIdList))
            for iter1189 in self.requestIdList:
                oprot.writeString(iter1189.encode('utf-8') if sys.version_info[0] == 2 else iter1189)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.mids is not None:
            oprot.writeFieldBegin('mids', TType.LIST, 2)
            oprot.writeListBegin(TType.STRING, len(self.mids))
            for iter1190 in self.mids:
                oprot.writeString(iter1190.encode('utf-8') if sys.version_info[0] == 2 else iter1190)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i1195 in range(_size1191):
                        _elem1196 = SendBuddyMessageResult()
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i1202 in range(_size1198):
                        _elem1203 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for iter1204 in self.success:
                oprot.writeString(iter1204.encode('utf-8') if sys.version_info[0] == 2 else iter1204)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
            oprot.writeFieldBegin('e', TType.STRUCT, 1)
...
class registerBuddy_args(object):
            ...
            if fid == 2:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i1230 in range(_size1226):
                        _key1231 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val1232 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.settings[_key1231] = _val1232
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.settings is not None:
            ...
            for kiter1233, viter1234 in self.settings.items():
                oprot.writeString(kiter1233.encode('utf-8') if sys.version_info[0] == 2 else kiter1233)
                oprot.writeString(viter1234.encode('utf-8') if sys.version_info[0] == 2 else viter1234)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class removeBuddyMembers_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i1239 in range(_size1235):
                        _elem1240 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.userMids.append(_elem1240)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.userMids is not None:
            oprot.writeFieldBegin('userMids', TType.LIST, 2)
            oprot.writeListBegin(TType.STRING, len(self.userMids))
            for iter1241 in self.userMids:
                oprot.writeString(iter1241.encode('utf-8') if sys.version_info[0] == 2 else iter1241)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i1246 in range(_size1242):
                        _elem1247 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.mids.append(_elem1247)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i1253 in range(_size1249):
                        _elem1254 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.mids.append(_elem1254)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i1260 in range(_size1256):
                        _elem1261 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.mids.append(_elem1261)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i1267 in range(_size1263):
                        _elem1268 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.mids.append(_elem1268)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class updateBuddyAdminProfileAttribute_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i1274 in range(_size1270):
                        _key1275 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val1276 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.attributes[_key1275] = _val1276
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            ...
            for kiter1277, viter1278 in self.attributes.items():
                oprot.writeString(kiter1277.encode('utf-8') if sys.version_info[0] == 2 else kiter1277)
                oprot.writeString(viter1278.encode('utf-8') if sys.version_info[0] == 2 else viter1278)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class updateBuddyProfileAttributes_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i1283 in range(_size1279):
                        _key1284 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val1285 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.attributes[_key1284] = _val1285
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            oprot.writeFieldBegin('attributes', TType.MAP, 2)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.attributes))
            for kiter1286, viter1287 in self.attributes.items():
                oprot.writeString(kiter1286.encode('utf-8') if sys.version_info[0] == 2 else kiter1286)
                oprot.writeString(viter1287.encode('utf-8') if sys.version_info[0] == 2 else viter1287)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class updateBuddyProfileAttributesAsync_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i1292 in range(_size1288):
                        _key1293 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val1294 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.attributes[_key1293] = _val1294
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            oprot.writeFieldBegin('attributes', TType.MAP, 2)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.attributes))
            for kiter1295, viter1296 in self.attributes.items():
                oprot.writeString(kiter1295.encode('utf-8') if sys.version_info[0] == 2 else kiter1295)
                oprot.writeString(viter1296.encode('utf-8') if sys.version_info[0] == 2 else viter1296)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class updateBuddySettings_args(object):
            ...
            if fid == 2:
                if ftype == TType.MAP:
                    ...
                    for _i1301 in range(_size1297):
                        ...
                        _val1303 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.settings[_key1302] = _val1303
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.settings is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.settings))
            for kiter1304, viter1305 in self.settings.items():
                oprot.writeString(kiter1304.encode('utf-8') if sys.version_info[0] == 2 else kiter1304)
                oprot.writeString(viter1305.encode('utf-8') if sys.version_info[0] == 2 else viter1305)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
